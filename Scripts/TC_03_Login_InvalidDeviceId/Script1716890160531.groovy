...
GlobalVariable.tempdeviceId = '09-hnhn'
...
if (WS.getResponseStatusCode(accessRes) == 400) {
    println('validation happening properly for invalid deviceId in the header')
} else {
    println('failed to validate the response when passing invalid deviceid in the header')
