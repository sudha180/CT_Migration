...
WS.verifyResponseStatusCode(AuthResponse, 400, FailureHandling.STOP_ON_FAILURE)

WS.verifyElementPropertyValue(AuthResponse, 'message', 'Missing mandatory headers: [correlationId]', FailureHandling.STOP_ON_FAILURE)

println(' Testcase got passed for the missing correlaion ID')
