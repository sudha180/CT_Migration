...
WS.verifyElementPropertyValue(AuthResponse, 'message', 'Missing mandatory headers: [deviceId]', FailureHandling.STOP_ON_FAILURE)

println(' Testcase got passed for the missing Deviceid')
