...
WS.verifyElementPropertyValue(AuthResponse, 'message', 'Missing mandatory headers: [brand]', FailureHandling.STOP_ON_FAILURE)

println(' Testcase got passed for the missing brand')
