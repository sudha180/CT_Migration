...
WS.verifyElementPropertyValue(AuthResponse, 'message', 'Missing mandatory headers: [channel]', FailureHandling.STOP_ON_FAILURE)

println(' Testcase got passed for the missing channel')
