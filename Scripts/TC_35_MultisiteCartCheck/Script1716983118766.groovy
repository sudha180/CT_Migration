...
//cart exists for LP and auth request sent for LP
...
cartId = WS.getElementText(authResponse, 'result.cartId')

println(cartId +"and" +GlobalVariable.cartId)

if (cartId.equalsIgnoreCase(GlobalVariable.cartId)) {
