...
//Update the device Id to invalid value
GlobalVariable.tempdeviceId = 'bfjds12#bfjsdf'
...
GlobalVariable.tempbrand = "L32423432432P"
GlobalVariable.tempchannel = "web"

//Print the value to verify if it is updated or not
